...
const ModalDescriptionTrashReport = ({ data, closeModal }) => {  
  ...
  return (
    <div className='fixed bg-[rgba(0,0,0,0.5)] top-0 left-0 right-0 bottom-0 flex items-center justify-center'>
      <div className='relative w-[600px] p-10 bg-white rounded-md'>
        ...
        <h1 className='font-medium text-black text-lg'>Deskripsi Lengkap Laporan Temuan</h1>
...
export default ModalDescriptionTrashReport