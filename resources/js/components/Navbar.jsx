...
const Navbar = () => {
  ...
  return (
    <header className='sticky top-0 flex flex-col z-[99999]'>
      <div className='flex flex-col space-y-1 bg-green-800 py-6 px-10 w-full'>
