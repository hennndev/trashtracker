          ...
          <div className='flex-[0.45] mr-10'>
            ...
            <form>
              <div className='flex flex-col space-y-1.5 mb-4'>
                ...
                <input type="text" placeholder='Input nama pelapor disini' className='border border-gray-300 outline-none rounded-md p-3'/>
              </div>
              <div className='flex flex-col space-y-1.5 mb-4'>
                <label htmlFor="pelapor">Deskripsi temuan sampah</label>
                <textarea rows={3} placeholder='Input deskripsi temuan sampah disini' className='border border-gray-300 outline-none rounded-md p-3'/>
              </div>
              <div className='flex flex-col space-y-1.5 mb-4'>
                <label htmlFor="pelapor">Lokasi lengkap temuan sampah</label>
                <textarea rows={3} placeholder='Input lokasi lengkap temuan sampah disini' className='border border-gray-300 outline-none rounded-md p-3'/>
              </div>
              <div className='flex flex-col space-y-1.5 mb-4'>
                <label htmlFor="pelapor">Koordinat Longitude</label>
                <input type="number" placeholder='Input koordinat longitude disini' className='border border-gray-300 outline-none rounded-md p-3'/>
              </div>
              <div className='flex flex-col space-y-1.5 mb-4'>
                <label htmlFor="pelapor">Koordinat Latitude</label>
                <input type="number" placeholder='Input koordinat latitude disini' className='border border-gray-300 outline-none rounded-md p-3'/>
              </div>

              <button className='py-3 px-6 text-center w-full bg-green-800 rounded-md outline-none text-white mt-5'>
                Laporkan temuan ini
              </button>
            </form>
